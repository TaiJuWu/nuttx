...
#define TCB_FLAG_POLICY_SHIFT      (3)                           /* Bit 3-5: Scheduling policy */
#define TCB_FLAG_POLICY_MASK       (7 << TCB_FLAG_POLICY_SHIFT)
...
#  define TCB_FLAG_SCHED_DEADLINE  (4 << TCB_FLAG_POLICY_SHIFT)  /* Sporadic scheding policy */

#define TCB_FLAG_CPU_LOCKED        (1 << 6)                      /* Bit 6: Locked to this CPU */
#define TCB_FLAG_SIGNAL_ACTION     (1 << 7)                      /* Bit 7: In a signal handler */
#define TCB_FLAG_SYSCALL           (1 << 8)                      /* Bit 8: In a system call */
#define TCB_FLAG_EXIT_PROCESSING   (1 << 9)                      /* Bit 9: Exitting */
#define TCB_FLAG_FREE_STACK        (1 << 10)                     /* Bit 10: Free stack after exit */
#define TCB_FLAG_HEAP_CHECK        (1 << 11)                     /* Bit 11: Heap check */
#define TCB_FLAG_HEAP_DUMP         (1 << 12)                     /* Bit 12: Heap dump */
#define TCB_FLAG_DETACHED          (1 << 13)                     /* Bit 13: Pthread detached */
#define TCB_FLAG_FORCED_CANCEL     (1 << 14)                     /* Bit 14: Pthread cancel is forced */
...
struct tcb_s
{
  ...
  FAR int32_t deadline;               /* Deadline first scheduler */
#endif
